...
For more info, please !tell @betatester1024.`, data, 0);
  ...
  if (msg.match(/^!aidungeon$/) && Math.random() < 1) {
    ...
    hnd.delaySendMsg(random([
      ...
      `You look about.`,
      `An elf walks jauntily out of the forest to your right, whistling a tune that, [YOU ARE OUT OF MOVES]`
    ]), data, 0);
    setTimeout(() => {
      hnd.changeNick(hnd.nick);
    }, 200);
  ...
  if (msg.match(/\bwin votes\b/) && Math.random() < 1) {
    hnd.changeNick("CueBot");
    hnd.delaySendMsg(`*find Pok\xE9mon`, data, 0);
    setTimeout(() => {
      hnd.changeNick(hnd.nick);
    }, 200);
    ;
  ...
  if (msg.match(/^(!smashbros|!smash-bros|smash bros|!smashwishlist|!smash|smash|smash wishlist|smashwishlist|!smash-wish-list)$/) && Math.random() < 1) {
    hnd.changeNick("CueBot");
    hnd.delaySendMsg(random([
      `Every Smash character merged into an Undertale-style Amalgamate`,
      `Crash Bandicoot`,
      `Undyne`,
      "Robert Downey Jr.",
      "Crewmate/Impostor",
      ...
      " Mavis Beacon",
      " The Blair Witch",
      " A Pokemon Snap Station",
      " That one alien Dr. Wily turns into",
      " Doctor Wah-wee from Mega Man 8",
      " Berenstein Bears (alt skin for Berenstain Bears)",
      " Meta-Meta-Meta-Knight",
      " ERROR from Adventure of Link",
      " The Letter H",
      " Mrs. Game and Watch",
      " The Left Paddle from Pong",
      " Some Minor Character From Final Fantasy",
      " A Fidget Spinner",
      " The KFConsole",
      " Mii Layabout",
      " Batman",
      " Final Destination",
      " Anybody who isn't Goku",
      " The Antigoku",
      " only one Ice Climber",
      " Florida Man",
      " Detective Pikachu",
      " Galoomba",
      " The dude who milks the cow in the 1-2 Switch Tutorial",
      " Loot Box",
      " Black Hat",
      " White Hat",
      " Beret Guy",
      " Masahiro Sakurai",
      " Smash Ball",
      " Every Pokemon (as one character)",
      " Professor Oak",
      " The Super Nintendo Entertainment System",
      " Reckless Safety Warning Guy from the Wii",
      " King Bob-Omb",
      " Elon Musk",
      " CATS",
      " Shovel Knight",
