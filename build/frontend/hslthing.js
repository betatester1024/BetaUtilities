...
var hslthing_exports = {};
__export(hslthing_exports, {
  hex_to_rgb: () => hex_to_rgb,
  hsl_to_rgb: () => hsl_to_rgb,
  hsv_to_rgb: () => hsv_to_rgb,
  linear_srgb_to_oklab: () => linear_srgb_to_oklab,
  okhsl_to_srgb: () => okhsl_to_srgb,
  okhsv_to_srgb: () => okhsv_to_srgb,
  oklab_to_linear_srgb: () => oklab_to_linear_srgb,
  rgb_to_hex: () => rgb_to_hex,
  rgb_to_hsl: () => rgb_to_hsl,
  rgb_to_hsv: () => rgb_to_hsv,
  srgb_to_okhsl: () => srgb_to_okhsl,
  srgb_to_okhsv: () => srgb_to_okhsv,
  srgb_transfer_function: () => srgb_transfer_function,
  srgb_transfer_function_inv: () => srgb_transfer_function_inv
});
module.exports = __toCommonJS(hslthing_exports);
...
function hsl_to_rgb(h, s, l) {
  ...
  if (s == 0) {
    ...
    let hue_to_rgb2 = function(p2, q2, t) {
      if (t < 0)
        t += 1;
      if (t > 1)
        t -= 1;
    ...
    var hue_to_rgb = hue_to_rgb2;
    let q = l < 0.5 ? l * (1 + s) : l + s - l * s;
    let p = 2 * l - q;
    r = hue_to_rgb2(p, q, h + 1 / 3);
    g = hue_to_rgb2(p, q, h);
    b = hue_to_rgb2(p, q, h - 1 / 3);
  }
...
//# sourceMappingURL=hslthing.js.map
