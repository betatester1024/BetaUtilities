...
THIS IS NOT THE REAL UTILS.JS FILE!

DO NOT MAKE CHANGES TO THIS FILE THAT YOU WANT TO GET CARRIED OVER!
...
async function globalOnload(cbk, networkLess = false, link = "/server") {
  ...
  let ftr = byId("ftrOverride");
  if (ftr) {
    ftr.innerHTML = `SmallSubway, by BetaOS. This footer should contain links to the rest of my site, but there's no server hosting here.`
  }
